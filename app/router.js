...
module.exports = app => {
  ...
  // router.get('/kk/load-rate-table-for-end', controller.kk.loadRateForEnd222);// 主页=>index
  ...
  // router.get('/kk/init-rate-for-end-2020', controller.kk.initRateForEnd222);// 主页=>index
  router.get('/kk/init-rate-for-end-2020', controller.kk.loadRateForEnd444);// 主页=>index
